...
=======
it('should redirect `index.html` to `index.html#!/walks', function() {
  browser.get('index.html');
  expect(browser.getCurrentUrl()).toContain('index.html#!/walks');
});

describe('View: Walk list', function() {

  beforeEach(function() {
    browser.get('index.html#!/walks');
  });
...
describe('View: Phone details', function() {
  ...
  beforeEach(function() {
    browser.get('index.html#!/walks/1');
  });

  it('should display placeholder page with `walkId`', function() {
    expect(element(by.binding('$ctrl.walkId')).getText()).toBe('1');
>>>>>>> Stashed changes
  });
